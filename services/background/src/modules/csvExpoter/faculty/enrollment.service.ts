...
import { facultyEnrollmentCsvRepository } from "./enrollment.repository";
import { toXlsxBuffer } from "../../../utils/xlsx";


export const facultyEnrollmentCsvService = {
    ...
    exportCourseEnrollments: async (event: any) => {
        try {
            ...
            const [course, enrollments] = await Promise.all([
                facultyEnrollmentCsvRepository.getCourse(courseId, client),
                facultyEnrollmentCsvRepository.getCourseEnrollments(courseId, client),
            ]);
